...
export function ProductCarousel({ title, slides, href, websiteUrl }: ProductCarouselProps) {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-zinc-900/40 border border-white/[0.08] rounded-3xl overflow-hidden hover:border-white/[0.15] transition-all duration-500 shadow-2xl group">
      ...
      {/* Content Area */}
      <div className="flex flex-col flex-grow p-6 md:p-8 relative z-30 -mt-8">
        ...
        {/* Shifting Subtitle Content */}
        <div className="min-h-[60px] flex items-start mb-auto">
          <p className="text-[15px] md:text-base text-zinc-400 font-medium leading-relaxed transition-opacity duration-300">
