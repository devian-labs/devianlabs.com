...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://devianlabs.com/products/${slug}` },
    openGraph: {
      url: `https://devianlabs.com/products/${slug}`,
      title: data.title,
      description: data.description,
    },
  };
  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      <div className="relative overflow-hidden border-b border-white/[0.06] px-4 md:px-6 py-16 md:py-24">
        <div className="absolute w-[500px] h-[500px] rounded-full bg-cyan-500/[0.12] blur-[100px] -top-40 -right-24 animate-orb-1 pointer-events-none will-change-transform" />
        <div className="absolute w-[350px] h-[350px] rounded-full bg-violet-600/[0.12] blur-[80px] bottom-0 left-0 animate-orb-2 pointer-events-none will-change-transform" />
        ...
        <div className="container relative z-10 mx-auto max-w-3xl">
          <Link
            href="/#products"
            className="inline-flex items-center gap-2 text-sm text-zinc-500 hover:text-cyan-400 mb-8 transition-colors duration-200 group"
          >
      ...
      <div className="px-4 md:px-6 py-16 md:py-24">
        <div className="container mx-auto max-w-3xl">
          <article className="prose prose-zinc dark:prose-invert max-w-none
            ...
            prose-code:text-cyan-300 prose-code:bg-zinc-800/60 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:before:content-none prose-code:after:content-none
            prose-pre:bg-zinc-900 prose-pre:border prose-pre:border-white/[0.07] prose-pre:rounded-2xl
            prose-blockquote:border-l-cyan-500/50 prose-blockquote:text-zinc-400
